...
CREATE OR REPLACE FUNCTION update_profile(name text DEFAULT NULL, date_of_birth date DEFAULT NULL, height_cm integer DEFAULT NULL, weight_kg integer DEFAULT NULL, area text DEFAULT NULL, latitude float8 DEFAULT NULL, longitude float8 DEFAULT NULL, years_of_experience integer DEFAULT NULL, fighting_style integer DEFAULT NULL, fight_type integer DEFAULT NULL, photos jsonb DEFAULT NULL)
    RETURNS void
    LANGUAGE plpgsql
    SECURITY DEFINER
    AS $$
