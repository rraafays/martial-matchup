...
import OSMMapView, { Details, Region } from "@/components/OSMapView";
...
export const LocationView: FC<Props> = ({ location, onLocationChange }) => {
    ...
    return (
        <View className="w-full h-3/5 justify-center items-center">
            ...
            />
            <View className="bg-black absolute py-2 px-4 rounded-md" pointerEvents="none">
                <Text className="text-white text-base font-poppins-regular">{neighborhood}</Text>
            </View>
        </View>
    );
};
